...
export default {
  data() {
    return {
      stripeAPIToken:'pk_test_51L8PI0SIMwwb0V4Hr8h2I6p0SrE1sRs4h4z2CzwBBm7ManZE1hGHvuZnMzTb2bxa30ijkOb0onUWj7r5tujW0aZg00jGqTyTDL',
      stripe: '',
      token: null,
      sessionId: null,
      checkoutBodyArray: [],
          ...
          if (response.status == 200) {
            ...
            for (let i = 0; i < len; i++)
              this.checkoutBodyArray.push({
                imageUrl: products.cartItems[i].product.imageURL, includeStripe( URL, callback ){
            let documentTag = document, tag = 'script',
                object = documentTag.createElement(tag),
                scriptTag = documentTag.getElementsByTagName(tag)[0];
            object.src = '//' + URL;
